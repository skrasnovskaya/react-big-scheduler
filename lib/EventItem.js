...
var EventItem = (_temp = _class = function (_Component) {
    ...
    _createClass(EventItem, [{
        ...
        value: function render() {
            ...
            var side = config.isRtl ? 'right' : 'left';
            var a = _react2.default.createElement(
                'a',
                { className: 'timeline-event', style: (_ref3 = {}, _defineProperty(_ref3, side, left), _defineProperty(_ref3, 'width', width), _defineProperty(_ref3, 'top', top), _ref3), onClick: function onClick() {
