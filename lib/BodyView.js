            ...
            var tableRows = renderData.map(function (item) {
                var rowCells = headers.map(function (header, index) {
                    ...
                    if (!!behaviors.getNonAgendaViewBodyCellBgColorFunc) {
                        var cellBgColor = behaviors.getNonAgendaViewBodyCellBgColorFunc(schedulerData, item.slotId, header, item);
                        if (!!cellBgColor) style = _extends({}, style, { backgroundColor: cellBgColor });
                    }
                    var customCellContent = !!behaviors.getNonAgendaViewBodyCellContent ? behaviors.getNonAgendaViewBodyCellContent(schedulerData, item.slotId, header, item) : null;
