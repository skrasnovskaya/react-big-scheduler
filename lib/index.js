...
var _BlockingLayer = require('./BlockingLayer');

var _BlockingLayer2 = _interopRequireDefault(_BlockingLayer);
...
var Scheduler = (_temp = _class = function (_Component) {
    ...
    _createClass(Scheduler, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                _props$centerCustomHe = _props.centerCustomHeader,
                centerCustomHeader = _props$centerCustomHe === undefined ? null : _props$centerCustomHe;
                ...
                tbodyContent = _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'scrollable-content', style: resourceContentStyle, ref: this.schedulerResourceRef, onMouseOver: this.onSchedulerResourceMouseOver, onMouseOut: this.onSchedulerResourceMouseOut, onScroll: this.onSchedulerResourceScroll },
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'scrollable-content', style: schedulerContentStyle, ref: this.schedulerContentRef, onMouseOver: this.onSchedulerContentMouseOver, onMouseOut: this.onSchedulerContentMouseOut, onScroll: this.onSchedulerContentScroll },
                                _react2.default.createElement(
                                    'div',
                                    { style: { width: schedulerWidth, height: contentHeight } },
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'scheduler-content', dir: 'ltr' },
                                        _react2.default.createElement(
                                            'table',
                                    ...
                                    _react2.default.createElement(_BlockingLayer2.default, this.props)
                                )
                            )
                        )
                    )
            ...
            if (config.headerEnabled) {
                schedulerHeader = _react2.default.createElement(
                    _row2.default,
                    { type: 'flex', align: 'middle', justify: 'space-between', style: { marginBottom: '24px' }, className: 'scheduler-header' },
                    leftCustomHeader,
                    _react2.default.createElement(
                        _col2.default,
                        null,
            ...
            return _react2.default.createElement(
                'table',
                { id: 'RBS-Scheduler-root', className: 'scheduler scheduler-view-' + viewType, style: { width: width + 'px' } },
                _react2.default.createElement(
                    'thead',
                    null,
                    _react2.default.createElement(
    ...
    centerCustomHeader: _propTypes.PropTypes.object,
    ...
    resolveScrollbarSizeOnUpdate: _propTypes.PropTypes.bool
    ...
    this.resolveScrollbarSize = function () {
        var _props2 = _this3.props,
            ...
            _props2$resolveScroll = _props2.resolveScrollbarSizeOnUpdate,
            resolveScrollbarSizeOnUpdate = _props2$resolveScroll === undefined ? true : _props2$resolveScroll;
